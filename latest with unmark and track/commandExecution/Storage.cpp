...
string Storage::displayTasks(){
    ...
    for (unsigned i=0; i< taskLists.size();i++){
        ...
        out << indexNumber << ". " << " month: " << taskLists[i].getMonth() << " day: " << taskLists[i].getDay() << " start time" << taskLists[i].getStartTime() << " end time" << taskLists[i].getEndTime() <<" unit number: "<<taskLists[i].getUnit()<<" status: "<<"undone"<<" Event: " << taskLists[i].getEventInformation() << endl;
		indexNumber++;
		}
    }
    return out.str();
...
string Storage::trackTasks(){
    ...
    for (unsigned i=0; i< taskLists.size();i++){
        ...
        out << indexNumber << ". " << " month: " << taskLists[i].getMonth() << " day: " << taskLists[i].getDay() << " start time" << taskLists[i].getStartTime() << " end time" << taskLists[i].getEndTime() <<" unit number: "<<taskLists[i].getUnit()<<" status: "<<"done"<<" Event: " << taskLists[i].getEventInformation() << endl;
		indexNumber++;
		}
    }
    return out.str();
