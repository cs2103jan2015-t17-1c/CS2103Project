...

{
	...
	this->outputBox->Size = System::Drawing::Size(1177, 432);
	...
	this->inputBox->Location = System::Drawing::Point(12, 459);
	...
	this->monthCalendar1->Location = System::Drawing::Point(12, 509);
	...
	this->textBox1->Location = System::Drawing::Point(473, 541);
	this->textBox1->Multiline = true;
	this->textBox1->Name = L"textBox1";
	this->textBox1->Size = System::Drawing::Size(648, 266);
	this->textBox1->TabIndex = 6;
	this->textBox1->Text = L"Coming soon";
	// 
	// label1
	// 
	...
	this->label1->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12.06283F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point, 
		static_cast<System::Byte>(0)));
	this->label1->Location = System::Drawing::Point(653, 500);
	this->label1->Name = L"label1";
	this->label1->Size = System::Drawing::Size(230, 38);
	this->label1->TabIndex = 7;
	this->label1->Text = L"What\'s up now";
	// 
	// EasiScheduler
	// 
	...
	this->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(118)), static_cast<System::Int32>(static_cast<System::Byte>(77)), 
		static_cast<System::Int32>(static_cast<System::Byte>(57)));
	this->ClientSize = System::Drawing::Size(1197, 836);
...
private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
			 ...
			 std::string recentTask=executor ->readRecentTask(1);
			 String^ MyRecentTask = gcnew String(recentTask.c_str());
