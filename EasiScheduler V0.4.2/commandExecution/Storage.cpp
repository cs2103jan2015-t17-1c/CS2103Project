...
string Storage::displayTasks(){
    ...
    for (unsigned i=0; i< _taskLists.size();i++){
		...
		if (_taskLists[i].getMark()==0){
           ...
           out<< "Unit No." << setw(4)<<_taskLists[i].getUnit()<<" "<< _taskLists[i].getStartYear() << "/" <<setw(2)<< _taskLists[i].getStartMonth() << "/" <<setw(2)<< _taskLists[i].getStartDay() << "/" << setw(4) << _taskLists[i].getStartTime() <<" - " << _taskLists[i].getEndYear() << "/" <<setw(2)<< _taskLists[i].getEndMonth()<< "/" <<setw(2)<< _taskLists[i].getEndDay() << "/" << setw(4) << _taskLists[i].getEndTime() <<"  " <<" Event: " << _taskLists[i].getEventInformation() << endl;

		   }

		   else if((_taskLists[i].getStartYear()==-1)&&(_taskLists[i].getEndYear()!=-1)){

		   out<< "Unit No." << setw(4)<<_taskLists[i].getUnit()<<" ----/--/--/---- - " << _taskLists[i].getEndYear() << "/" <<setw(2)<< _taskLists[i].getEndMonth()<< "/" <<setw(2)<< _taskLists[i].getEndDay() << "/" << setw(4) << _taskLists[i].getEndTime() <<"  "<<" Event: " << _taskLists[i].getEventInformation() << endl;

		   }

		   else{

		   out<< "Unit No." << setw(4)<<_taskLists[i].getUnit()<<" ----/--/--/---- - ----/--/--/----  " <<" Event: " << _taskLists[i].getEventInformation() << endl;
